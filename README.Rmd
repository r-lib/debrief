...
debrief provides text-based summaries and analysis tools for [profvis](https://profvis.r-lib.org/) profiling output. It's designed for terminal workflows and AI agent consumption, offering views including hotspot analysis, call trees, source context, caller/callee relationships, and memory allocation breakdowns.
